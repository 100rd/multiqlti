...
const ENV_MAPPINGS: EnvMapping[] = [
  ...
  { envKey: "LMSTUDIO_ENDPOINT",configPath: ["providers", "lmstudio", "endpoint"],     kind: "string"  },
  { envKey: "TAVILY_API_KEY",   configPath: ["providers", "tavily", "apiKey"],          kind: "string"  },
  { envKey: "ANTIGRAVITY_ENABLED",   configPath: ["providers", "antigravity", "enabled"],   kind: "boolean" },
  { envKey: "ANTIGRAVITY_BIN_PATH",  configPath: ["providers", "antigravity", "binPath"],   kind: "string"  },
  { envKey: "ANTIGRAVITY_MODEL",     configPath: ["providers", "antigravity", "model"],     kind: "string"  },
  { envKey: "ANTIGRAVITY_TIMEOUT_MS",configPath: ["providers", "antigravity", "timeoutMs"], kind: "number"  },
  ...
  { envKey: "MULTI_PROVIDERS_LMSTUDIO_ENDPOINT",    configPath: ["providers", "lmstudio", "endpoint"],           kind: "string"  },
  { envKey: "MULTI_PROVIDERS_TAVILY_API_KEY",        configPath: ["providers", "tavily", "apiKey"],               kind: "string"  },
  { envKey: "MULTI_PROVIDERS_ANTIGRAVITY_ENABLED",   configPath: ["providers", "antigravity", "enabled"],         kind: "boolean" },
  { envKey: "MULTI_PROVIDERS_ANTIGRAVITY_BIN_PATH",  configPath: ["providers", "antigravity", "binPath"],         kind: "string"  },
  { envKey: "MULTI_PROVIDERS_ANTIGRAVITY_MODEL",     configPath: ["providers", "antigravity", "model"],           kind: "string"  },
