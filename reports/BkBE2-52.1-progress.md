...
- F1 security veto fix: sourceType-aware upsert (update only when existing.sourceType==='git'); new status:'conflict' + existingSourceType field, no write on manual/builtin/cross-team collision; added builtin-collision test; tsc clean; new suite 3 files/22 tests; full suite 304/304 files 5171 passed/5 skipped 0 failed
