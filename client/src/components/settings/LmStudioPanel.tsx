...
/**
 * LM Studio connection + model-import panel. Renders content only (no section
 * wrapper) so it can be embedded inside the collapsed "local models" block
 * alongside the vLLM / Ollama status. See issue #346.
 */
